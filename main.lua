...
local CP1 = {
    ...
    CFrame.new(802.49, 2144.06, 3911.50) * CFrame.Angles(0,0,0),
    CFrame.new(803.20, 2151.44, 3917.96) * CFrame.Angles(0,0,0),
    CFrame.new(801.32, 2154.88, 3921.03) * CFrame.Angles(0,0,0)
}
